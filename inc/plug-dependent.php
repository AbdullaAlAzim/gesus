...
function gesus_single_title($arg){

        if ( is_category() ) {
            /* translators: Category archive title. 1: Category name */
            $title = single_cat_title( $arg['cat'], 'gesus',false);
        } elseif ( is_tag() ) {
            /* translators: Tag archive title. 1: Tag name */
            $title = single_cat_title( $arg['tag'], 'gesus',false);
        } elseif ( is_author() ) {
...
function gesus_unit_breadcumb($separator = '<i class="fas fa-chevron-right"></i>') {
    /* === OPTIONS === */
    ...
    $wrap_before    = '<ol class="breadcrumb" itemscope="http://schema.org/BreadcrumbList">'; // the opening wrapper tag
    $wrap_after     = '</ol><!-- .breadcrumb -->'; // the closing wrapper tag
    $sep            = '<li class="breadcrumb-item separator"> '.$separator.' </li>'; // separator between crumbs
    ...
    global $post;
    $home_url       = home_url('/');
    $link           = '<li class="breadcrumb-item" itemscope itemtype="http://schema.org/ListItem">';
