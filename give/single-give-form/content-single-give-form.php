...
<div id="give-form-<?php the_ID(); ?>-content" <?php post_class('card gesus-featured-card featured-card-big mt-0'); ?>>
    ...
    <div class="<?php echo apply_filters('give_forms_single_summary_classes', 'summary card-body entry-summary'); ?>">
